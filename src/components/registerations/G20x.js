...
const eventRegister = () => {
  ...
  function HandleEventClick(e) {
    ...
    e.preventDefault();
    fetch(
      "https://script.google.com/macros/s/AKfycbxx5_H2ZVBbiL2qAorgSspD1Qvtflr9z8ZiwyMe9PCbNAnxCXmNQlViJAyoNnvbFJlr/exec",
      {
        method: "POST",
        body: formDatab
      }
    ...
    <>
      ...
      >
        <div className="col-lg-7 col-md-12 col-12 form-step">
          ...
          >
            <h2 className="font-normal">G20x Anantya</h2>
            <div id="personalInfo">
          ...
          >
            ...
            >
              <input
                name="Name"
                type="submit"
                className="Button-for-submission"
              />
              <ToastContainer />
            </div>
          </form>
