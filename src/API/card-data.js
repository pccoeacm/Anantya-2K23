...
const cardData = [
  ...
  
    {
      ...
      date:"28/03/2023",
      short_description:"WebBit is all about web development. There will be two rounds. Technologies allowed are HTML, CSS, and JavaScript (the use of frameworks is allowed). From the second round, a winner and a runner-up will be declared based on unique and innovative designs",
      detailed_description:"This contest is about web development. There will be two rounds. Technologies allowed are HTML, CSS, and JavaScript (the use of frameworks is allowed). From the second round, a winner and a runner-up will be declared based on unique and innovative designs",
      Type:"Solo",
      ...
      rule3:"⦿ Only technologies mentioned in the description can be used. Evaluation will be done based on the uniqueness of design, time taken and understand-ability of the code.",
      rule4:"⦿ In round-1 if two participants acquire a similar score, based on time taken one of the candidates will be selected for the next round.",
      rule5:"⦿ If copyright for any design from any resource is found, they will be disqualified.",
    ...
    },
    {
      ...
      event_name:"Perplexo",
      date:"27/03/2023",
      short_description:"Perplexo is an event testing knowledge in Internet and Technology. It includes tricky questions, hints, and a live leaderboard. Last year, one reached level 6, but none completed the challenge. We are PerPlexo We Choose the Best.",
      detailed_description:"Perplexo is an event where you get to test your knowledge in the wide domain of the Internet and Technology. It is an event consisting of a series of questions, a trail of hints followed by a sequence of surprisingly tricky answers along with a live ranking leader board. We return with greater difficulty, tougher ciphers and deeper trails. You have to be more attentive, cautious and aware than at any time you are. Push your limits, bend the rules and crack the code. Last year only one was able to reach level 6, but none completed the challenge. 𝐖𝐞 𝐚𝐫𝐞 𝐏𝐞𝐫𝐏𝐥𝐞𝐱𝐨 𝐖𝐞 𝐂𝐡𝐨𝐨𝐬𝐞 𝐭𝐡𝐞 𝐁𝐞𝐬𝐭.",
      Type:"Duo",
    ...
    },
    {
        ...
        date:"",
        short_description:"Hackathon is a technical event for developing innovative projects based on relevant computer science technologies. Participants present their implementation to a jury in two rounds, with 20 teams qualifying for the final round. Teams must implement changes suggested by reviewers before the final presentation.",
        detailed_description:"A hackathon is a technical event where participants have to implement their innovative ideas and develop their projects within a stipulated time. The project must be based on any computer science relevant technologies, such as web apps, Android apps, IoT, ML models, networks, security, and automation. The event will consist of two rounds. In the first round, participants will present their problem statements and implementations to the internal jury using a presentation within a given amount of time (Review 1). After the evaluation of the first round, 20 teams will qualify for the next round. The qualified teams will need to incorporate the suggestions/changes given by the reviewers within a specific time frame and prepare for the final presentation, which will be evaluated by the jury.",
        ...
        rule2:"⦿ All the intermediate evaluation processes during Offline Hackathon should be followed.",
        rule3:"⦿ All the group members should be present during the presentation.",
        rule4:"⦿ Participants have to begin with their work on 22nd March and First round will be conducted by the Faculty allotted on 23th March.",
        rule5:"⦿ Those Teams which get selected, certain changes will be communicated to the respective teams which they will be expected to do overnight.",
    ...
    },
    {
      ...
      date:"27/03/2023",
      short_description:"The Cosmic Aptitude Test has 3 rounds. Round 1 has 120 participants taking a Level 1 quiz. Round 2 has 40 participants taking a Level 2 quiz and Round 3 has 10 participants taking Reading and Writing tests.",
      detailed_description:"Cosmic Aptitude Test consisting of 3 rounds. Round 1 has 120 participants taking a Level 1 Aptitude quiz with 30 MCQs. Round 2 has 40 participants taking a Level 2 Aptitude quiz with 20 MCQs covering verbal, analytical, and quantitative skills. Round 3 has 10 participants taking two rounds, Reading comprehension and Writing, where they will be given an RC sheet to solve and write essays on assigned topics, respectively, evaluated using scoremyessay.com.",
      Type:"Solo",
        ...
        rule1:"⦿Participants are not allowed calculators for 1 Round but they can bring scientific calculators for round 2.",
        rule2:"⦿Participants must bring pen and paper for rough work for rounds 1 and 2.",
    ...
    },
    {
        ...
        date:"27/03/2023",
        short_description:"Experience a real-time IPL Auction with 210+ players and 10 teams bidding for their desired players. Each player is rated and teams submit their playing 11 for a final team rating. The team with the highest rating wins. Enjoy the excitement of the IPL Auction!",
        detailed_description:"Welcome to the real-time IPL Auction featuring 210+ players. Ten teams will participate in the auction, with each team bidding on the 210+ players and selecting their desired team. All players in the list have been assigned ratings. Each team must submit their playing 11, and the final team rating will be calculated based on the submitted playing 11. The team with the highest points based on their rating will be declared the winner. Join us and experience the thrill of the IPL Auction in real-time.",
        Type:"Team of 4",
        prize1:"Prizes Worth Rs. 6500",
        prize2:"",
        prize3:"",
      ...
      },
    {
      ...
      date:"27/03/2023",
      short_description:"Innovation and entrepreneurship drive the world forward. Startups foster new ideas, from recognition to scrutiny, leading to success",
      detailed_description:"Innovation and entrepreneurship are the wheels that steer the world into a brighter future. Startup mania will help in innovating new ideas right from acknowledging the potential of your idea, steering your ideas in the right direction and scrutinizing your views which will pave the way for glaring success. In the idea presentation round, every team has to present their ideas using the template provided.The institute will provide guidance and funding to all innovative startup ideas.",
      Type:"Team of 1 to 4",
        prize1:"Prizes Worth Rs. 3500",
        prize2:"",
        prize3:"",
        ...
        rule3:"⦿ ROUND1: You can make a video or reel to introduce your product in the form of an advertisement. The top teams will be decided via poll by panel members.",
    ...
    },
    {
      ...
      date:"28/03/2023",
      short_description:"The Alpha Analyst event to test your trading skills based on real market based situation without the risk of loosing real money.",
      detailed_description:"The Alpha Analyst event to test your trading skills based on real market based situation without the risk of loosing real money.",
      Type:"Team of 3",
    ...
    },
    {
        ...
        rule5:"⦿ In case of a tie in any round the organizers will be taking the final decision",
    ...
    },
    {
      ...
      },
      {
        ...
        date:"28/03/2023",
        short_description:"You and a friend were engaged in a game when suddenly your device was hacked. Let's seek assistance from Team OWASP to track down this cybercriminal. We can identify the hacker if  we apply some basic level IQ & fun logic to find the treasure.",
        detailed_description:"You and a friend were engaged in a game when suddenly your device was hacked. Let's seek assistance from Team OWASP to track down this cybercriminal. We can identify the hacker if  we apply some basic level IQ & fun logic to find the treasure. There will be three levels, and as you pass each one, the hacker will appear closer to you. Somewhere in your vicinity is a hidden chest containing the clues you need to identify the hacker. Let's go on a treasure hunt together.",
        Type:"Duo",
        ...
        faculty:"Mr. Ganesh DeshMukh",
        rule1:"⦿ ROUND - 1 (Death-or-Glory) ➨ Round 1 includes a quiz consisting of 20 questions based of situational trivia.",
        rule2:"⦿ Every team will be ranked on the maximum score of the submission. If two teams have the same score, the team that finished earlier will be ranked higher.",
        rule3:"⦿ ROUND - 2 (You can’t catch me) ➨ Only 30 teams will qualify for round 2.",
        rule4:"⦿ There will be questions based on the places inside the campus and the teams which answer the questions correctly and faster will move on to the next round.",
        rule5:"⦿ ROUND - 3 (Let me iiiinnnnn) ➨ Only top 15 teams will qualify for round 3. ",
